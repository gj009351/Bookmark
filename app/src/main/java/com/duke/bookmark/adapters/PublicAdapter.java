...
import com.duke.bookmark.activities.NewBookmarkActivity;
...
public class PublicAdapter extends RecyclerView.Adapter<PublicAdapter.ViewHolder>
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        @BindView(R.id.textview_num_saved) TextView textViewNumSaved;
        @BindView(R.id.textview_full_url) TextView textViewFullUrl;
        @BindView(R.id.imageview_share) ImageView imageViewShare;
        @BindView(R.id.imageview_save) ImageView imageViewSave;
        @BindView(R.id.textview_score) TextView textViewScore;
        @BindView(R.id.cardview_score) CardView cardViewScore;
