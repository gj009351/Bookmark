...
import com.duke.bookmark.activities.EditBookmarkActivity;
...
public class PrivateAdapter extends RecyclerView.Adapter<PrivateAdapter.ViewHolder>
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.card_view1) CardView cardView;
        @BindView(R.id.imageview_favicon) ImageView imageViewFavicon;
        @BindView(R.id.textview_title) TextView textViewTitle;
        @BindView(R.id.textview_domain) TextView textViewDomain;
        @BindView(R.id.linearlayout_detail) LinearLayout linearLayoutDetail;
        @BindView(R.id.flowlayout_tags) FlowLayout flowLayout;
        @BindView(R.id.textview_date_saved) TextView textViewDateSaved;
        @BindView(R.id.textview_full_url) TextView textViewFullUrl;
        @BindView(R.id.imageview_delete) ImageView imageViewDelete;
        @BindView(R.id.imageview_share) ImageView imageViewShare;
        @BindView(R.id.imageview_edit) ImageView imageViewEdit;
