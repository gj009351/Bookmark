...
import com.duke.bookmark.adapters.PrivateAdapter;
...
public class PrivateTagDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.coordinatorlayout_private_tag_detail) CoordinatorLayout mCoordinatorLayout;
    @BindView(R.id.recyclerview_private_tag_detail) RecyclerView mRecyclerView;
