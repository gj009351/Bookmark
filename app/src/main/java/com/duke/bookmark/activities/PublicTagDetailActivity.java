...
public class PublicTagDetailActivity extends BaseActivity {
    ...
    @BindView(R.id.coordinatorlayout_public_tag_detail) CoordinatorLayout mCoordinatorLayout;
    @BindView(R.id.recyclerview_public_tag_detail) RecyclerView mRecyclerView;
