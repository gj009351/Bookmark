...
import com.duke.bookmark.models.PrivateBookmark;
import com.duke.bookmark.models.PrivateTag;
import com.duke.bookmark.views.TagsCompletitionView;
...
public class NewBookmarkActivity extends BaseActivity {
    ...
    @BindView(R.id.imageview_favicon) ImageView mImageViewFavicon;
    @BindView(R.id.textview_title) TextView mTextViewTitle;
    @BindView(R.id.edittext_title_custom) EditText mEditTextTitleCustom;
    @BindView(R.id.edittext_add) EditText mEditTextAdd;
    @BindView(R.id.completitionview) TagsCompletitionView mCompletitionView;
    @BindView(R.id.textview_done) TextView mTextViewDone;
    @BindView(R.id.textview_cancel) TextView mTextViewCancel;
    @BindView(R.id.linearlayout_detail) LinearLayout mLinearLayoutDetail;
    @BindView(R.id.linearlayout_detail_separator) LinearLayout mLinearLayoutSeparator;
    @BindView(R.id.linearlayout_title) LinearLayout mLinearLayoutTitle;
    @BindView(R.id.progressbar) ProgressBar mProgressBar;
    @BindView(R.id.coordinatorlayout) CoordinatorLayout mCoordinatorLayout;
    @BindView(R.id.imageview_paste) ImageView mPaste;
    @BindView(R.id.imageview_add_custom_title) ImageView mIconCustomTitle;
    @BindView(R.id.imageview_add_tags) ImageView mIconTags;
