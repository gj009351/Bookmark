...
import com.duke.bookmark.adapters.ViewPagerAdapter;
import com.duke.bookmark.adapters.ZoomOutPageTransformer;
import com.duke.bookmark.fragments.TagsFragment;
...
public class MainActivity extends BaseActivity implements FirebaseFragment.Callbacks {
    ...
    @BindView(R.id.floating_action_menu) FloatingActionMenu mFab;
    @BindView(R.id.toolbar) Toolbar mToolbar;
    @BindView(R.id.tablayout) TabLayout mTablayout;
    @BindView(R.id.viewpager) ViewPager mViewpager;
    @BindView(R.id.floating_action_button_add) FloatingActionButton mFabAdd;
    @BindView(R.id.floating_action_button_tags) FloatingActionButton mFabTags;
    @BindView(R.id.floating_action_button_order) FloatingActionButton mFabOrder;
    @BindView(R.id.relativelayout_fake_fab) RelativeLayout mFakeFab;
    @BindView(R.id.relativelayout_fake) RelativeLayout mFake;
