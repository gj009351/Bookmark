...
import com.duke.bookmark.views.CirclePageIndicator;
import com.duke.bookmark.views.ColorShades;
...
public class AppIntroActivity extends AppCompatActivity {
    ...
    @BindView(R.id.circlepageindicator) CirclePageIndicator mCirclePageIndicator;
