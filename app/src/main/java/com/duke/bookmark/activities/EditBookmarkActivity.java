...
public class EditBookmarkActivity extends BaseActivity {
    ...
    @BindView(R.id.card_view1) CardView mCardView;
    @BindView(R.id.imageview_favicon) ImageView mImageViewFavicon;
    @BindView(R.id.textview_title) TextView mTextViewTitle;
    @BindView(R.id.textview_domain) TextView mTextViewDomain;
    @BindView(R.id.textview_full_url) TextView mTextViewFullUrl;
    @BindView(R.id.textview_date_saved) TextView mTextViewDateSaved;
    ...
    @BindView(R.id.textview_delete) TextView mTextViewDelete;
    @BindView(R.id.coordinatorlayout) CoordinatorLayout mCoordinatorLayout;
    @BindView(R.id.flowlayout_tags) FlowLayout mFlowLayout;
